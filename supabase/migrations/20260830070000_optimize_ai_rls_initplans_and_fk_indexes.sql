...
--
-- Some AI/Studio tables are not present in the clean open-source migration
-- graph used by CI. Keep this migration replay-safe across both schemas:
-- optimize those relations when present, without making a clean rebuild fail.
