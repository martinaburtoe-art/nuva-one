-- Historial de incidentes del Vigía de producción (sin PII).
-- Acceso solo vía service_role (Actions / server functions del Owner).
...
-- Explicit deny policies document the intended public/authenticated boundary.
