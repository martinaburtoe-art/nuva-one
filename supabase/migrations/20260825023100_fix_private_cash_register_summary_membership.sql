-- Keep the privileged cash summary implementation tenant-safe after moving
-- the RPC implementation into private.
CREATE OR REPLACE FUNCTION private.get_cash_register_summary(p_cash_register_id uuid)
RETURNS TABLE(
