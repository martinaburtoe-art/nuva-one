-- Serializa aprobaciones de permisos/vacaciones por trabajador para
-- evitar carreras entre saldo disponible, solapamientos e inserción de ausencias.
...
BEGIN
  ...
  -- Serializa las aprobaciones del mismo trabajador.
  PERFORM 1
  FROM public.people_employees e
