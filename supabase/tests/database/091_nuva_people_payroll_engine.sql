...
SELECT has_function('public','calculate_people_vacation_balance(uuid,date)','vacation calculation function exists');
SELECT has_function('public','prepare_people_lre(uuid)','LRE preparation function exists');
SELECT has_function('public','approve_people_payroll_period(uuid)','approval function exists');
SELECT has_function('public','close_people_payroll_period(uuid)','close function exists');
SELECT has_function('public','generate_people_liquidations(uuid)','liquidation function exists');
