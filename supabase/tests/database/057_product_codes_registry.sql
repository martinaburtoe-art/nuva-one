...
SELECT ok(EXISTS (SELECT 1 FROM pg_indexes WHERE schemaname='public' AND tablename='product_codes' AND indexname='ux_product_codes_business_code' AND indexdef LIKE 'CREATE UNIQUE INDEX%'),'codes are unique per business');
