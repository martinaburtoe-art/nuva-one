...
export function createTaxAuditEvent(
  input: Omit<TaxAuditEvent, "id"> & { id?: string },
): TaxAuditEvent {
...
export function appendTaxAuditEvent(
  events: readonly TaxAuditEvent[],
  event: TaxAuditEvent,
): TaxAuditEvent[] {
