...
export const AI_TOOLS: AiToolDefinition[] = [
  ...
  {
    id: "studio.image_edit",
    label: "Nüva Creative Edit",
    ...
    dailyLimit: 2,
    monthlyLimit: 10,
    description: "Edición y transformación de imágenes.",
  },
  {
    id: "studio.voice",
    label: "Nüva Voice",
  ...
  },
  {
    ...
    dailyLimit: 5,
    monthlyLimit: 30,
    description: "Diagnóstico y prioridades estratégicas.",
  },
  {
    id: "studio.document",
    label: "Nüva Documents",
    capability: "document",
    provider: "google",
    model: process.env.GEMINI_MODEL ?? "gemini-3.1-pro-preview",
    enabled: true,
    ...
    dailyLimit: 5,
    monthlyLimit: 30,
    description: "Documentos empresariales y reportes.",
  },
  {
