...
type ProductRow = { stock?: number | string | null; low_stock_threshold?: number | string | null; reorder_point?: number | string | null; price?: number | string | null; name?: string | null; sku?: string | null };
...
export function buildNuvaOperationalResult(input: NuvaOperationalInput): NuvaOperationalResult {
  ...
  const snapshot: OperationalSnapshot = {
    ...
    cashAvailable, projectedCash30d: cashAvailable, overdueReceivables, revenue, inventoryValue, lowStockSkus, stockoutRisk,
    grossMargin: null, taxMismatchAmount: 0, complianceReadiness: 100,
