...
export function buildNuvaOperationalResult(input: NuvaOperationalInput): NuvaOperationalResult {
  ...
  const snapshot: OperationalSnapshot = {
    ...
    cashAvailable, projectedCash30d, overdueReceivables, revenue, inventoryValue, lowStockSkus, stockoutRisk,
    grossMargin: null, taxMismatchAmount: null, complianceReadiness: null,
