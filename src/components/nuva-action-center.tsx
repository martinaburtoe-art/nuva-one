...
const actionHref = (id: string) => ({ "low-stock": "/inventory", "receivables-overdue": "/crm", "purchase-pressure": "/purchases", "cash-burn": "/finance", "growth-opportunity": "/customers" } as Record<string, string>)[id] ?? "/dashboard";
