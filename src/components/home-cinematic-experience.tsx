...
const SCENES: Scene[] = [
  { id: "hero", number: "01", video: "/Chilean_retail_shop_opens_morning_20260918131053.mp4", eyebrow: "EL NEGOCIO REAL", title: "Todo empieza aquí.", body: "Tu negocio ya está funcionando. Nüva One entra en escena para conectar lo que ocurre detrás de cada venta.", visual: "store-open", metric: "07:42", metricLabel: "apertura", context: BASE_CONTEXT, action: "OBSERVA" },
...
function SceneVisual({ scene, sceneProgress }: { scene: Scene; sceneProgress: number }) {
  ...
  const scale = 1.01 + sceneProgress * 0.035;
