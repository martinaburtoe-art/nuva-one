...
export function LiveProductScanner({ open, onOpenChange, onScan, onResolved, onProductFound, onCodeNotFound, title = "Nüva Live" }: LiveProductScannerProps) {
