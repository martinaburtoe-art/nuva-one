  ...
  return (
    <Dialog open={open} onOpenChange={(value) => { if (!value) stop(); onOpenChange(value); }}>
      <DialogContent className="max-w-lg overflow-hidden p-0">
        <DialogHeader className="px-4 pt-4"><DialogTitle className="flex items-center gap-2"><ScanBarcode className="h-5 w-5 text-primary" />{title}</DialogTitle></DialogHeader>
