...
const titles: Partial<Record<SceneId, string>> = {
        ...
        <div className="flex h-[78%] items-end gap-2 pt-10">
          {[31, 46, 39, 59, 52, 73, 66, 87, 78, 94, 82, 100].map((h, i) => (
            <div
              ...
              style={{ height: `${Math.min(100, h + phase * 4)}%`, opacity: 0.45 + i * 0.035 }}
            />
          ))}
        </div>
      )}
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-7 text-center text-[9px] uppercase tracking-[.35em] text-white/25">
