...
const FEEDS = [
  {
    url: "https://www.sii.cl/rss/noticias.xml",
    source: "SII",
    category: "Tributario",
    icon: Scale,
  },
  {
    url: "https://www.sercotec.cl/feed/",
    source: "Sercotec",
...
const FALLBACK: NewsItem[] = [
  ...
  },
  {
    ...
    category: "Tributario",
    summary:
      "Consulta las últimas novedades, instrucciones y comunicaciones oficiales del Servicio de Impuestos Internos.",
  },
  {
  ...
  return (
    <Card className="overflow-hidden border-primary/15 bg-gradient-to-br from-primary/[0.04] via-background to-background">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="gap-1 text-[10px]">
                  <Sparkles className="h-3 w-3" /> Actualización automática
                </Badge>
              </div>
              <h2 className="mt-1 text-lg font-semibold">
                Noticias y oportunidades que pueden mover tu negocio
              </h2>
              <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                Fondos, cambios tributarios, leyes, programas públicos, digitalización y
                oportunidades relevantes para PYMEs chilenas.
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t bg-muted/20 px-5 py-3 text-[11px] text-muted-foreground md:px-6">
        ...
        <span>
          Las noticias se muestran desde fuentes oficiales; Nüva no garantiza plazos ni adjudicación
          de convocatorias.
        </span>
      </div>
    </Card>
