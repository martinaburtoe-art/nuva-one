...
export function LandingValueSystem() {
  return (
    <section className="border-y bg-background py-20" aria-labelledby="value-system-title">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {pillars.map((item) => (
              <Card key={item.label} className="border-border/60 p-4">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="relative mt-12 grid gap-4 md:grid-cols-4">
          ...
          {workflow.map((item, index) => (
            <Card key={item.title} className="relative z-10 border-border/60 bg-card p-5">
        ...
        <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-5 sm:flex-row sm:items-center sm:justify-between">
