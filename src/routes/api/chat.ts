...
const SPECIALIST_PROFILES: Record<Specialist, string> = {
  ...
  crm:
    "Actúas como especialista en clientes y CRM. Analiza cartera, recurrencia, concentración, actividad y oportunidades. Propón segmentaciones y acciones comerciales, sin inventar información de contacto ni actividad.",
  strategy:
