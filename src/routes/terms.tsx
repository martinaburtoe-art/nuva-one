  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 prose prose-slate dark:prose-invert">
        ...
        <h2>1. Aceptación</h2>
        <p>Al usar Nüva One aceptas estos términos en su totalidad.</p>
        ...
        <p>Nüva One se entrega "tal cual", sin garantías implícitas o explícitas más allá de las exigidas por ley.</p>
        <h2>6. Contacto</h2>
