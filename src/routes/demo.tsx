...
import { CinematicMotionStyles, CinematicReveal } from "@/components/motion/cinematic-reveal";
...
function DemoExperience() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {mounted ? (
        <CinematicReveal delayMs={90} y={28}>
          <DemoWorkspace
            onExit={() => {
