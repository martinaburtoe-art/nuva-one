              ...
              return (
                <button
                  ...
                  className={`w-full rounded-2xl border p-5 text-left transition-all ${
                    active === index
                      ? "border-primary/30 bg-background shadow-lg"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {modules.map(([Icon, title, desc]) => (
            <Card key={title as string} className="rounded-2xl p-5 transition-shadow hover:shadow-lg">
    ...
    <section className="border-y bg-secondary/15 py-20 sm:py-28" id="pricing">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-muted-foreground sm:text-lg">
            Prueba Nüva One durante 15 días, sin tarjeta, y descubre qué cambia cuando todo tu negocio
            está conectado.
          </p>
        </div>
    ...
    <section id="faq" className="py-20 sm:py-28">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">Lo que necesitas saber.</h2>
        </div>
      ...
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-foreground px-6 py-14 text-background shadow-2xl sm:px-12 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-background/70 sm:text-lg">
            Empieza con 15 días gratis y descubre cómo cambia la forma en que gestionas y entiendes tu
            negocio.
          </p>
