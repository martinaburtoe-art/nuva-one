    ...
    <ModuleGuard module="customers">
      <div className="space-y-5">
        ...
        {loading ? (
          ...
          <>
            <Card className="overflow-hidden rounded-2xl border-primary/20 bg-gradient-to-br from-primary/[0.06] via-background to-background p-5 shadow-sm md:p-6">
          ...
          <>
            ...
            {activeSection === "command" && <NuvaExecutiveCommandCenter customers={customers ?? []} sales={sales ?? []} activities={activities ?? []} quotes={quotes ?? []} products={products ?? []} executionScore={executionScore} decision={decision!} dataSources={connectedSources} totalDataSources={dataSources.length} />}
