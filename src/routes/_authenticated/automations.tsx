          ...
          <div className="w-full flex-1">
            ...
            {ownerLink && (
              <p className="mt-3 text-xs text-muted-foreground">
                Vinculado: +{ownerLink.owner_phone_number}. Escríbele al número de WhatsApp de Nüva
                One para empezar a preguntar por tu negocio.
              </p>
            )}
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="w-full flex-1">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  ...
                  Business (vía Meta Cloud API, gratis hasta 1.000 conversaciones/mes) para que tus
                  CLIENTES te escriban directamente y reciban stock/precios automáticos. También
                  habilita los recordatorios automáticos de cotizaciones y cobranza.
                </p>
