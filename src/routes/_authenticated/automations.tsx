...
function WhatsAppLinking() {
  ...
  return (
    <ModuleGuard module="automations">
      <>
        <PageHeader title="Automatizaciones y conexiones" description="Conecta WhatsApp y prepara automatizaciones externas para que Nüva One trabaje con tu operación." />
