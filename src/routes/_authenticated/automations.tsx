...
export const Route = createFileRoute("/_authenticated/automations")({
  head: () => ({ meta: [{ title: "Automatizaciones y conexiones — Nüva One" }] }),
