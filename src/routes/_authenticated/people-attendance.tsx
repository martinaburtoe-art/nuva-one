...
function PeopleAttendance() {
  ...
  return <ModuleGuard module="people"><div className="p-4 md:p-6"><PageHeader title="Asistencia y jornada" description="Registra entradas, salidas e incidencias y deja los eventos disponibles para remuneraciones." />
