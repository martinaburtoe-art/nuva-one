...
export const Route = createFileRoute("/_authenticated/business-health")({ head: () => ({ meta: [{ title: "Business Health — Nüva One" }] }), component: BusinessHealth });
...
function BusinessHealth() {
  ...
  const intelligence = useMemo(() => buildBusinessHealthIntelligence({ sales, customers, products, activities, cashFlow, reconciliation }), [sales, customers, products, activities, cashFlow, reconciliation]);
