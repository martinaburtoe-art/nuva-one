...
const oldCta = '<Link to="/demo"><Button size="sm">Explorar demo completa <ArrowRight className="ml-1 h-3.5 w-3.5" /></Button></Link>';
const newCta = '<Link to="/demo"><Button size="sm">Descubrir todo Nüva One <ArrowRight className="ml-1 h-3.5 w-3.5" /></Button></Link>';
...
if (changed) {
  ...
  console.log("Homepage showcase enhancements already applied or source changed; no modification needed");
}
