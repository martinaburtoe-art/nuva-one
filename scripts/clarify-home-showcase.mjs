...
const oldDescription = "Explora los módulos principales y descubre, de un vistazo, cómo puedes gestionar tu negocio desde un solo lugar.";
const newDescription = "Explora algunas de nuestras herramientas para gestionar, analizar y hacer crecer tu PYME. Este showcase representa solo una parte de la plataforma: Nüva One reúne muchas más funcionalidades para administrar tu negocio desde un solo lugar.";
